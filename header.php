...
<html class="no-js" <?php language_attributes(); ?> >
  ...
  <header id="masthead" class="masthead site-header" role="banner">
    ...
    <nav id="site-navigation" class="site-navigation main-navigation top-bar" role="navigation">
      <div class="top-bar-left">
        <ul class="menu">
          <!-- <li class="home"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><span><?php bloginfo( 'name' ); ?></span></a></li> -->
        </ul>
      </div>
